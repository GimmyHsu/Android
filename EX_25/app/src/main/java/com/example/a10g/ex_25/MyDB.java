...
public class MyDB {
    ...
    private final static String DATABLE_NAME="db1.db";
    ...
    public void open() throws SQLException{
        db=mCtx.openOrCreateDatabase(Context.DROPBOX_SERVICE,0,null);
        try {
...
public boolean update(long rowId,String name,int price){
        ContentValues arge=new ContentValues();
        arge.put(NAME,name);
        arge.put(PRICE,price);
        return db.update(TABLE_NAME,arge,_ID+"="+rowId,null)>0;
}
}
